...
public class SoapWSConfig {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema){
        ...
        defaultWsdl11Definition.setPortTypeName("LoanEligibilityController");
        defaultWsdl11Definition.setLocationUri("/ws");
        defaultWsdl11Definition.setTargetNamespace("http://www.phos.com/ws/soap/api/loanEligibility");
